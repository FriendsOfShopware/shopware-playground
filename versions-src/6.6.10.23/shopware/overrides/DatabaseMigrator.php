...
/**
 * Playground override (Shopware 6.6: 3-arg constructor, no clock/ini reader):
 * small batches, skip WASM-hostile migrations, and continue when a step
 * throws instead of freezing the installer UI.
 *
 * @internal
 */
#[Package('framework')]
